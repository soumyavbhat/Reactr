...
function positionContentContainer() {
 ...
 var sideMenuItemFour = document.querySelector('.side-menu .menu-buttons:nth-child(4)');
 ...
 var profileImgHeight = sideMenuItemThree.offsetHeight + sideMenuItemFour.offsetHeight;
 var sectionHeaderHeight = sideMenuItemThree.offsetHeight + sideMenuItemFour.offsetHeight;

 // console.log(sideMenuItemThree.offsetHeight + sideMenuItemFour.offsetHeight);
 ...
 profileImg.style.cssText = 'height: ' +  profileImgHeight + 'px;';

 sectionHeader.style.cssText = 'height: ' +  sectionHeaderHeight + 'px;';
}
...
// adding the project and program dropdown menu

var showProject = document.querySelector('.secondProject');
var showButton = document.querySelector('.expand-button');

function projectsToggler() {
 showProject.classList.toggle('toggleProject');
 showButton.classList.toggle('toggleButton');
}

showButton.addEventListener('click', projectsToggler, false);

var showProgram = document.querySelector('.secondProgram');
var showButtonTwo = document.querySelector('.expand-button-two');

function programToggler() {
 showProgram.classList.toggle('toggleProgram');
 showButtonTwo.classList.toggle('toggleButtonTwo');
}

showButtonTwo.addEventListener('click', programToggler, false);
